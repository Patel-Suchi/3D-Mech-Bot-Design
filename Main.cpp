...
GLfloat robotBody_mat_diffuse[] = { 0.9f,0.9f,0.9f,0.9f };
GLfloat robotBody_mat_shininess[] = { 32.0F };


GLfloat robotArm_mat_ambient[] = { 0.0215f, 0.1745f, 0.0215f, 0.55f };
GLfloat robotArm_mat_diffuse[] = { 1.0f,1.0f,1.0f,1.0f };
...
GLfloat gun_mat_diffuse[] = { 1.0f,1.0f,1.0f,1.0f };
...
GLfloat robotLowerBody_mat_diffuse[] = { 1.0f, 1.0f, 1.0f, 1.0f };
...
void drawRobot()
{
	glPushMatrix();
	 ...
	 glRotatef(WheelRotation*20.0, 0.0, 1.0, 0.0);
	 glTranslatef(0.0, 0.0, 0.0);
	 glPushMatrix();
	 drawLowerBody();
	 glPopMatrix();
...
void drawBody()
{
	...
	glRotatef(90, 1.0, 0.0, 0.0);
	drawSphere(0.55, 20, 20);
	glTranslatef(0.0, 0.0, -0.5);
	glRotatef(90, 0.0, 0.0, 1.0);
	glutSolidCylinder(0.4, 0.8, 10, 10);
	glPopMatrix();
	
	gluCylinder(gluNewQuadric(), 0.4, 0.4, 1.2, 20, 10);
	glPopMatrix();
}
...
void drawHead()
{
	...
	glTranslatef(0, 0.55 * robotBodyLength + 0.55 * headLength, 0);
	glRotatef(90.0, 1.0, 0.0, 0.0);
	
	

	glPushMatrix();
	glScalef(0.3 * robotBodyWidth, 0.3 * robotBodyWidth, 0.3 * robotBodyWidth);
	...
	glPushMatrix();
	// Position head with respect to parent (body)
	glTranslatef(0, 0.7*robotBodyLength+0.7*headLength, 0); // this will be done last
	...
	gluDisk(gluNewQuadric(),1.0, 1.0, 10, 10);
...
void drawLowerBody()
{
	...
	glRotatef(WheelRotation*1.5, 0.0, 1.0, 0.0);
	
	// Position wheel and base with respect to body
...
void drawLeftArm()
{
	...
	glTranslatef(-(0.5 * robotBodyWidth + 0.5 * upperArmWidth), 0.1 * upperArmLength, 0.0);
	...
	// build arm
	glPushMatrix();
	glScalef(upperArmWidth+3, upperArmLength*0.35, upperArmWidth+3);
	glRotatef(90, 0.0, 1.0, 0.0);
	...
	glTranslatef(4.7, (0.05 * upperArmLength + 0.05 * gunLength), 2.0);

	// build gun
	glRotatef(90, 1.0, 0.0, 0.0);
	glScalef(gunWidth + 1, gunLength, gunDepth + 6);
	glutSolidCylinder(0.5, 1.0, 20, 20);
	glPopMatrix();
